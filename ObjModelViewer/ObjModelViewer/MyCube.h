...
void MyCube::Quad (int a, int b, int c, int d, vec4 * vin, vec4 * cin)
{
	...
	//Vertices[NumCurVertices].normal = vec3(vin[d].x, vin[d].y, vin[d].z);
	Vertices[NumCurVertices].normal = n;
	NumCurVertices++;
}
